...
class ACNO_Agent_OTP:
    ...
    def run(self, nmbr_episodes, get_full_results=True):
        ...
        rewards[:exp_eps], steps[:exp_eps] = self.model.sample_model(
    ...
    def run_episode(self, epoch):
        ...
        while not done and steps < self.max_steps:
            ...
            action = solver.select_eps_greedy_action(
                0, start_time, greedy_select=False
            ).bin_number
        ...
        print(
            "{} episodes complete (current reward = {}, nmbr steps = {}, nmbr measurements = {})".format(
                epoch, totalreward, steps + 1, measurements
            )
        )
