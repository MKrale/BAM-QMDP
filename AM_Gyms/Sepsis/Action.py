...
class Action(object):
    ...
    def __init__(self, selected_actions=None, action_idx=None):
        assert (selected_actions is not None and action_idx is None) or (
            selected_actions is None and action_idx is not None
    ...
    def __eq__(self, other):
        return (
            ...
            and self.antibiotic == other.antibiotic
            and self.ventilation == other.ventilation
            and self.vasopressors == other.vasopressors
        )
